<template>
  ...
  <div class="home mt-5 sm:mt-1">
    <div class="sub_header flex text-gray-500 text-sm ">
      ...
      <router-link to="/tv" class="mx-3 active_type cursor-pointer">
        TV Shows
      </router-link>
    ...
    <div class="w-full text-xl text-center font-bold mt-4 sm:mt-0">TV Series</div>
    ...
    export default {
        ...
        methods:{
            getMovieTvData(){
                ...
                axios.get('https://api.themoviedb.org/3/tv/popular?api_key=fb0951eca3f429fba7a17ace3baedfc2&page='+pageNo+'&include_adult=false').then((response => {
